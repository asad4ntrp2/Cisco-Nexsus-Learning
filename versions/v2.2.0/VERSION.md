...
- Section 3.7: Dual-Active Detection (DAD) added to Part 3
  - Detection methods table (Peer-Keepalive, DAD Link, ePAgP, BFD, Fast Hello)
  - ASCII diagrams for vPC and StackWise Virtual DAD scenarios
  - NX-OS keepalive configuration example
  - Cross-technology comparison table (vPC vs SVL vs VSS)
- Section 3.8: Private VLANs (PVLANs) added to Part 3
  - Three port types table (Promiscuous, Community, Isolated)
  - ASCII communication matrix diagram
  - Vibrant gradient SVG diagram (purple, green, blue, red, gold color scheme)
  - Full NX-OS PVLAN configuration (9 steps) with verification commands
  - PVLAN in VXLAN EVPN section with VNI mapping table
- Part 15: EVPN Comprehensive Guide (new section)
  - 4 EVPN types comparison table
  - 5 deployment environments table
  - 6 real-world use case cards (grid layout)
  - EVPN service types (E-LAN, E-LINE, E-TREE) with ASCII diagrams
- Part 16: Stacking vs VPC — Complete Comparison (new section)
  - Stacking technologies table
  - vPC architecture ASCII diagram
  - 10-aspect comparison table
  - Use cases grid (stacking vs vPC, 4 each)
  - Decision matrix ASCII flowchart
  - Pros/cons tables for both technologies
  - Device compatibility tables (side-by-side)
  - Enterprise coexistence architecture ASCII diagram

**Diagram Gallery Updates:**
- 9th diagram: Private VLAN Architecture with vibrant gradient styling
- Gallery header updated: "9 Diagrams"
- Lightbox JavaScript updated for 9 diagrams

**Navigation & UI Updates:**
- Sidebar: New "Advanced Topics" group with Parts 15-16
- Sidebar version updated to v2.2.0
- Landing page: 16 Study Sections, 9 Diagrams, 6-Day Study Plan
- About section updated with DAD, PVLANs, Stacking vs VPC
- Key Interview Topics: added DAD, PVLANs, Stacking vs VPC

**Study Plan Updates:**
- 6-Day Study Plan (was 5-day)
- Day 2 updated: L2 + DAD + PVLANs
- Day 4 updated: EVPN + Part 15
- Day 6 added: Advanced Topics + Review (Part 16, DAD, Q&A)
- Self-check: Parts 15-16 checkboxes added

**Glossary Updates:**
- 17 new terms: DAD, SVL, MEC, PVLAN, VPLS, VPWS, E-LAN, E-LINE, E-TREE, SR, SRv6, PBB, DCI, VSS, ePAgP, MEF

**Version Archive:**
- New `versions/` directory with per-release snapshots
- Folders: v1.1.0, v1.2.0, v1.3.0, v1.3.1, v2.0.0, v2.1.0
- Each contains index.html, README.md, VERSION.md (+ continue.md where applicable)
- `versions/README.md` with structure documentation and version history table

**Stats:** index.html grew from 4,467 lines (v2.1.0) to ~5,800+ lines (v2.2.0)
